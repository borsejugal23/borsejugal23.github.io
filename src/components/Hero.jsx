...
export function HeroSection() {
  ...
  const handleDownload = () => {
    ...
    const downloadUrl = 'https://drive.google.com/file/d/1EQrYO4iJCWda9_LrAxYttEXzl0UXRvG-/view?usp=sharing';
  ...
  return (
    <div className={styles.rootCont}  id="home">
      <Fade>
        <div className={styles.nameCont}>
          <p>Hi,</p>
          <p>
            I am <span>Jugal</span>{" "}
          </p>
          <p>Web Developer</p>
          <a
            href="https://drive.google.com/file/d/1_zEJQvhtWEo5yrROZUTteAp_SVR1oYJV/view?usp=sharing"
            target="_blank"
